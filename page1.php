...
@keyframes animate {
  ...
  <ul id="menuList" class="menu inactive">
    ...
    <li class="item"><a href="main.php"><i class="fa-light fa-circle-question"></i>Jafar</a></li>
		...
		<h1><font size="20" color="navy">Jafar's skills and abilities</font><br></h1>
		<p>
			<font size="5">talent and motivated at <b>football</b> (and also footsall).<br>
			able to walk for a long time e.g. experienced in <b>climbing</b> trecks.<br>
			<b>patient</b> at solving problems.
			able to <b>clarify</b> difficult problems so others may solve them eazier.<br>
			types as an average speed of 27 wpm.<br>
			dosen't ignore the <b>details</b>.<br>
			familiar with C and C++ in a basic level.<br>
			...</font>
		</p>
	<footer class="footer" >
	<div class="waves">
