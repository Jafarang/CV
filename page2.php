<html>
	<head>
	<title>honors and achivements</title>
	<style>
			* {
  padding: 0;
  margin: 0;
...
@keyframes animate {
  ...
  <ul id="menuList" class="menu inactive">
    ...
    <li class="item"><a href="main.php"><i class="fa-light fa-circle-question"></i>Jafar</a></li>
		...
		<h1><font size="20" color="navy">Jafar's honors and achivements</font><br></h1>
		<p>
			<font size="5">
			bronze medal in Iran math olympiad.<br>
			rating 30 in Konkour.<br>
			have crested Kooh-e-Shah the peak of Lalezar mountains.<br>
			have been in the football team of the class at school for a long time.<br>
			...
			</font>
		</p>
		<footer class="footer" >
