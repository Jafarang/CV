...
@keyframes animate {
  ...
  <ul id="menuList" class="menu inactive">
    ...
    <li class="item"><a href="main.php"><i class="fa-light fa-circle-question"></i>Jafar</a></li>
		...
		<br><center><img src="flo.jpg" alt="Jafar in the mirror" width="200" height="200"></center>
		
		<h1><font size="20" color="navy">Jafar (also known as Amin)</font><br></h1>
		<p><font size="5">	Born in Kerman in 2004<br>
			graduated from Helli-1-Kerman highschool<br>
			studying CE in Sharif.</font>			
		</p>
<footer class="footer" >
	<div class="waves">
